...
function App() {
  ...
  const fetchWeather = async (city) => {
    ...
    try {
      const url = `${API_URL}?q=${trimmedCity}&units=metric&appid=${API_KEY}`;
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-blue-100 relative overflow-hidden px-4">
      <video
        autoPlay
        loop
        muted
